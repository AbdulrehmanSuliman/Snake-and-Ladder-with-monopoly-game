...
int Output::GetCellStartX(const CellPosition & cellPos) const
{
	...
	{
	int xcell=cellPos.HCell()*UI.CellWidth;

	return xcell; // this line should be changed with your implementation
	}
	return 0;
}
...
int Output::GetCellStartY(const CellPosition & cellPos) const
{
	...
	{
	///TODO: implement the following function as described in Output.h file
	int ycell=cellPos.VCell()*UI.CellHeight+UI.ToolBarHeight;
	return ycell;// this line should be changed with your implementation
	}
	return 0;
}
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_DELETE_GAME_OBJECT]="images\\DELETEGRID.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_INPUT_DVALUE]="images\\D_INPUT.jpg";
	///TODO: Prepare images for each menu item and add it to the list
...
{
	ClearStatusBar(); // to clear what was written 
...
void Output::DrawLadder(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	{
		pWind->DrawLine(x12,i,x34-1,i-1);
	}	
}
}
//////////////////////////////////////////////////////////////////////////////////////////
...
xpoly[1] = x12;
	...
	pWind->DrawPolygon(xpoly, ypoly, 4);
