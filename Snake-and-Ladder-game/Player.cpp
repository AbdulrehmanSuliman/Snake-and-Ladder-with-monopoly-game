...
int Player::getdicenumber() const
{
	return justRolledDiceNum;
}
void Player::setdicenumber(int diceN)
{
	justRolledDiceNum = diceN;
}
void Player::setCanPlay(bool canp)
{
	CanPlay = canp;
}
...
void Player::Move(Grid * pGrid, int diceNumber)
{
	...
	if (CanPlay == true)
	{
		...
		int number = (pCell->GetCellPosition()).GetCellNum();
		stepCount += number;
